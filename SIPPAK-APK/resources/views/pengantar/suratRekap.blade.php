            ...
            <table class="table">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="font-bold text-black">Dibuat</th>
                        <th class="font-bold text-black">Download</th>
                    </tr>
                </thead>
                ...
                <tbody id="tableBody">
                    ...
                    @foreach ($surat as $item)
                        <tr class="hover">
                            ...
                            <td>{{ $item->tanggal }}</td>
                            <td><a class="tombol bg-info" href="/DownloadSurat/{{ $item->id_surat }}">Download</a></td>
                        </tr>
                        @php
                            $count++;
                        @endphp
