...
<header class="centered-header">
    ...
    <div class="text-right bg-slate-200 h-14 p-2 shadow-lg">
    ...
    <div class="inline-block w-[80%] ml-40 my-5">
        @foreach ($data as $dat)
            <div data-user-card class="collapse collapse-arrow bg-slate-200 mb-5 shadow-lg">
                <input type="radio" name="my-accordion-2" checked="checked" />
                <div data-header class="collapse-title text-xl font-medium">
                    {{$dat->nama_pns}}
