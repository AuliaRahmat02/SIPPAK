        ...
        <div class="bg-white p-6 shadow-lg rounded-lg overflow-hidden w-4/5 flex">
            ...
            <div class=" bg-blue-2 ml-1 inline-block p-8" style="width: 100%; padding:10px">
                ...
                <form action="/regist" method="POST">
                    ...
                    <div class="mb-4">
                        <label for="name" class="block text-sm font-medium text-gray-700">Biro</label>
                        <select name="biro" id="biro" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            <option value="1">Biro Pemerintahan dan Otonomi Daerah</option>
                            <option value="2">Biro Hukum</option>
                            <option value="3">Brio Administrasi Pimpinan</option>
                            <option value="4">Biro Kesejahteraan Rakyat</option>
                            <option value="5">Biro Perekonomian</option>
                            <option value="6">Biro Administrasi Pembangunan</option>
                            <option value="7">Biro Organisasi</option>
                            <option value="8">Biro Umum</option>
                            <option value="9">Biro Pengadaan Barang dan Jasa</option>
                        </select>
                        @error('biro')
                            <small class="text-red-400">{{ $message }}</small>
                        @enderror
