...
@section('isi')
    ...
    <div class="p-2 text-right shadow-xl bg-slate-200 h-14">
        <input type="text" id="search" data-search
            class="inline-block px-2 py-1 mr-8 rounded-lg shadow-xl h-11 w-80 focus:outline-none focus:border-sky-500 focus:ring-2 focus:ring-sky-500"
            placeholder="NIP, nama, golongan, jabatan,">
    </div>
    <div class="inline-block w-[80%] ml-40 my-5">
        @foreach ($data as $dat)
            <div data-user-card class="mb-5 shadow-xl collapse collapse-arrow bg-slate-200">
                <input type="radio" name="my-accordion-2" checked="checked" />
                <div data-header class="text-xl font-medium collapse-title">{{ $dat->nama_pns }}</div>
                <div data-body class="collapse-content">
                    <ul>
                        ...
                        <li><b>Cuti Yang Tersedia: </b>{{ $dat->jatah_cuti }}</li>
                    </ul>
